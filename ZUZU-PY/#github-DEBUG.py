...
with open("thankyou00.txt",'w', encoding='utf-8') as file:   #新建输出文件
    ...
    for line in lines:  #查找每一行
		#如果IP当中包含下面数字
        if line.find("http://27.10") != -1 or line.find("http:/220.176.218") != -1 or line.find("http://171.221.129") != -1 or line.find("http://118.122.111") != -1 or line.find("http://27.191.71") != -1 or line.find("http://175.11.171") != -1 or line.find("http://220.176.218") != -1 or line.find("http://117.43.80") != -1 or line.find("http://182.139.152") != -1 or line.find("http://118.122.111") != -1 or line.find("http://118.112.60") != -1 or line.find("http://27.191.71") != -1 or line.find("http://122.232.188") != -1 or line.find("http://125.71.44") != -1 or line.find("http://122.234.77") != -1 or line.find("http://122.232.188") != -1 or line.find("http://14.105.105.35") != -1 or line.find("http://27.191.71.248") != -1 or line.find("http://144.255.40.160") != -1 or line.find("http://140.250.221") != -1 or line.find("http://223.242.146") != -1 or line.find("http://182.139.215") != -1 or line.find("http://182.150.168") != -1 or line.find("http://120.32.11") != -1 or line.find("http:113.86.204.209") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1:    #在or后面添加更多需要删除的http://xxx地址-注意冒号结尾-中间没有冒号
...
# 开始去重复-打开文档并读取所有行 
with open('thankyou00.txt', 'r', encoding="utf-8") as file:
...
# 将唯一的行写入新的文档 
with open('thankyou.txt', 'w', encoding="utf-8") as file:
