...
with open("thankyou.txt",'w', encoding='utf-8') as file:   #新建输出文件
    ...
    for line in lines:  #查找每一行
		#如果IP当中包含下面数字
        if line.find("http://27.10") != -1 or line.find("http://218.89") != -1 or line.find("http://220.175") != -1 or line.find("http://106.86") != -1 or line.find("http://113.71") != -1 or line.find("http://221.197") != -1 or line.find("http://182.32") != -1 or line.find("http://171.214") != -1 or line.find("http://116.252") != -1 or line.find("http://144.255") != -1 or line.find("http:/220.176.218") != -1 or line.find("http://171.221.129") != -1 or line.find("http://118.122.111") != -1 or line.find("http://27.191.71") != -1 or line.find("http://175.11.171") != -1 or line.find("http://106.118") != -1 or line.find("http://220.176.218") != -1 or line.find("http://117.43.80") != -1 or line.find("http://182.139.152") != -1 or line.find("http://118.122.111") != -1 or line.find("http://27.11.50") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1:    #在or后面添加更多需要删除的http://xxx地址-注意冒号结尾-中间没有冒号
