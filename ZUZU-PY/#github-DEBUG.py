...
#键入需要修改关键字
    content = content.replace("CHC", "CHD").replace("里番", "里帆").replace("剧", "裾").replace("电视", "电S").replace("央视", "秧视").replace("兵器", "宾器").replace("三立", "三笠").replace("台湾", "苔塆").replace("澳门", "奥门").replace("东森", "岽森").replace("人间", "朲间").replace("电影", "电颢").replace("棋牌", "祺排").replace("风云", "风纭").replace("凤凰", "鳳煌").replace("WA", "").replace("WB", "").replace("WC", "").replace("WD", "").replace("WE", "").replace("WF", "").replace("WG", "").replace("WH", "").replace("WI", "").replace("WJ", "").replace("WK", "").replace("WL", "").replace("WM", "").replace("WN", "").replace("WO", "").replace("WP", "").replace("WP", "").replace("WQ", "").replace("WR", "").replace("WS", "").replace("WT", "").replace("WU", "").replace("WV", "").replace("WW", "").replace("WX", "").replace("WY", "").replace("WZ", "").replace("X纪实", "纪寳").replace("X金鹰", "金莺").replace("Y卡酷", "佧酷").replace("Y动漫", "动曼").replace("Y金色学堂", "琻色学堂").replace("卡通", "佧通").replace("电Y", "电颢").replace("剧J", "裾集").replace("老DY", "老电颢").replace("德华", "得铧").replace("星驰", "煋池").replace("成龙", "晟珑").replace("李连杰", "李联杰").replace("林正英", "箖正瑛").replace("梁家辉", "樑家晖").replace("洪金宝", "葓琻寳").replace("王晶", "王橸").replace("古惑", "-GH").replace("战争", "-ZZ").replace("救援", "-JY").replace("贺岁", "-HS").replace("贝爷", "北夜").replace("谍战", "解放").replace("港片", "港弯片").replace("玄幻", "奇幻").replace("黄渤", "潢勃").replace("润发", "闰䥽").replace("巨石", "钜什").replace("强森", "墙森").replace("沈腾", "沈藤").replace("洪金宝", "洪琻寳").replace("功夫片", "武峡").replace("动画片", "动话片").replace("小鬼头", "-XGT").replace("坦森", "袒森").replace("灾难", "世纪").replace("犯罪", "形事").replace("古墓", "寻幕").replace("港片", "巷片").replace("黑帮", "团派").replace("斗争", "打杖").replace("斗鱼", "逗鱼").replace("神乐", "绅乐").replace("国产", "国内").replace("悬疑", "玄嶷").replace("怪兽", "乖乖绶").replace("恐怖", "抓瑰").replace("死神", "斯神").replace("女神", "钕神").replace("滴血", "嘀桖").replace("X乐", "乐").replace("X求", "求").replace("X纪", "记").replace("X记", "记").replace("X金", "金").replace("Y动", "动").replace("Y卡", "咔").replace("Y咔", "咔").replace("Y嘉", "佳").replace("Y新", "新").replace("电Y", "电颢").replace("剧J", "裾集").replace("重Q", "重庆").replace("北J", "北京").replace("河B", "河北").replace("河N", "河南").replace("天J", "天津").replace("广D", "广东").replace("湖B", "湖北").replace("湖N", "湖南").replace("山D", "山东").replace("安H", "安徽").replace("江S", "江苏").replace("山X", "山西").replace("浙J", "浙江").replace("辽L", "辽宁").replace("吉L", "吉林").replace("贵Z", "贵州").replace("陕X", "陕西").replace("S川", "四川").replace("GAT-", "").replace("电信", "電信").replace("联通", "蓮通").replace("香港", "萫港").replace("裾J", "裾集").replace("江X", "江西").replace("新J", "新疆").replace("CF", "").replace("IV", "").replace("广X", "广西").replace("A", "").replace("B", "").replace("F", "").replace("G", "").replace("I", "").replace("J", "").replace("K", "").replace("L", "").replace("M", "").replace("N", "").replace("O", "").replace("P", "").replace("Q", "").replace("R", "").replace("S", "").replace("U", "").replace("W", "").replace("X", "").replace("Y", "").replace("Z", "").replace("C新闻", "新闻").replace("电颢C", "电颢").replace("电颢E", "电颢").replace("电颢H", "电颢").replace("裾集C", "裾集").replace("裾集D", "裾集").replace("裾集E", "裾集").replace("D影视", "影视").replace("E都市", "都市").replace("H新农", "新农").replace("河北C", "河北").replace("河北D", "河北").replace("河南C", "河南").replace("河南D", "河南").replace("天津C", "天津").replace("天津D", "天津").replace("天津E", "天津").replace("广东C", "广东").replace("广东H", "广东").replace("广西C", "广西").replace("广西D", "广西").replace("广西E", "广西").replace("广西H", "广西").replace("湖北C", "湖北").replace("湖北D", "湖北").replace("山东C", "山东").replace("山东D", "山东").replace("山东E", "山东").replace("山东H", "山东").replace("安徽C", "安徽").replace("安徽D", "安徽").replace("安徽E", "安徽").replace("安徽H", "安徽").replace("江西C", "江西").replace("江西D", "江西").replace("江西E", "江西").replace("江西H", "江西").replace("陕西C", "陕西").replace("陕西D", "陕西").replace("陕西E", "陕西").replace("陕西H", "陕西").replace("浙江C", "浙江").replace("浙江D", "浙江").replace("浙江E", "浙江").replace("浙江H", "浙江").replace("四川C", "四川").replace("四川D", "四川").replace("四川E", "四川").replace("四川H", "四川").replace("辽宁C", "辽宁").replace("辽宁D", "辽宁").replace("辽宁E", "辽宁").replace("辽宁H", "辽宁").replace("吉林C", "吉林").replace("山西C", "山西").replace("山西D", "山西").replace("山西E", "山西").replace("山西H", "山西").replace("党员教育", "教育").replace("政法", "政律").replace("融媒", "传楳").replace("党员教育", "教育")
...
with open("AMERICAM-over.txt",'w', encoding='utf-8') as file:   #新建输出文件
    ...
    for line in lines:  #查找每一行
        ...
        if line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1 or line.find("http://27.10") != -1:    #在or后面添加更多需要删除的http://xxx地址
